...
| 版本    | 类型        | 更新说明                                                     | 发布时间       |
| ------- | ----------- | ------------------------------------------------------------ | -------------- |
| 2.0.6 | Feature | Pod 独立子网支持 NAT 网关出网管理 | 2026年8月26日 |
| 2.0.5 | Bugfix | 修复从 v1 升级至 v2 后，IPAMD 借调可能选中过期 Ipamd CR 的问题 | 2026年8月10日 |
| 2.0.4 | Feature / Bugfix | 新增 UNI RPS、辅助 UNI MTU 同步、CNI 初始化和 IPAMD 诊断，并修复 IP 借调后的 GARP/MAC 处理 | 2026年8月7日 |
